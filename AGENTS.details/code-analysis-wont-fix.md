...
- `tests/paragraph-visual-lines.test.mjs` (`completeness-audit.todo-marker`): The "reported bug" comment simply documents the rationale for a regression test and is not a pending action item.
