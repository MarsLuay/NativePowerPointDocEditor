...
async function handleSetImageCrop(
	context: PptxOpExecutionContext,
	payload: Record<string, unknown>,
...
async function handleFitImageToFrame(
	context: PptxOpExecutionContext,
	payload: Record<string, unknown>,
): Promise<PptxOpExecutionResult> {
	const result = createExecutionResult();
...
async function handleReplaceImageFromShape(
	context: PptxOpExecutionContext,
	payload: Record<string, unknown>,
): Promise<PptxOpExecutionResult> {
	const result = createExecutionResult();
...
async function executeMediaOp(
	...
	switch (opId) {
		case 'pptx.setImageCrop':
			return handleSetImageCrop(context, payload);
		case 'pptx.fitImageToFrame':
			return handleFitImageToFrame(context, payload);
		case 'pptx.resetImage':
			return handleResetImage(context, payload);
		case 'pptx.replaceImage':
			return handleReplaceImage(context, payload);
		case 'pptx.replaceImageFromShape':
			return handleReplaceImageFromShape(context, payload);
		default:
			return null;
	}
}
