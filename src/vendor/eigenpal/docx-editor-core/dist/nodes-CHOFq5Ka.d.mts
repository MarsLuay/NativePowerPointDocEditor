...
import { d as ParagraphAlignment, L as LineSpacingRule, S as SpacingExplicit, e as TabStop, T as TextFormatting, P as ParagraphFormatting, F as FloatingTableProperties, f as TableLook, a as TableFormatting, c as TableCellFormatting, b as TableRowFormatting } from './formatting-DFtuRFQY.mjs';
import { N as NumberFormat } from './lists-CyGxd5Y2.mjs';
import { WrapType } from './docx/wrapTypes.mjs';
import { R as RunPropertyChange, S as SectionProperties, a as RevisionInfo, b as ParagraphPropertyChange, c as TablePropertyChange, d as TableCellPropertyChange, e as TableRowPropertyChange } from './content-BZ9rYecc.mjs';
