...
const REACT_DYNAMIC = ['react', 'react-dom', 'react-dom/client', '@npde/docx-editor-react'];
const VUE_DYNAMIC = ['vue', '@npde/docx-editor-vue'];

const NO_REACT_MSG = `Vue/core files cannot import React. Use @npde/docx-editor-core for shared logic. ${SPEC}`;
const NO_VUE_MSG = `React/core files cannot import Vue. Use @npde/docx-editor-core for shared logic. ${SPEC}`;
