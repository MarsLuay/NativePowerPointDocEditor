...
if (pkgArgIdx !== -1) {
  ...
  if (!next || next.startsWith('--')) {
    console.error(`--package requires a value, e.g. --package @npde/docx-editor-core`);
    process.exit(1);
  }
}
...
if (pkgArg && !pkgArg.startsWith('@')) {
  console.error(`--package expects a package name like '@npde/docx-editor-core', got '${pkgArg}'`);
  process.exit(1);
}
