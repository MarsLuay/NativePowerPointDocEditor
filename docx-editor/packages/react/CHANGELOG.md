...
- f61435b: Harden `openPrintWindow` to build the print window via DOM APIs instead of `document.write`, so a crafted document title cannot break out into executable markup. The framework-agnostic print helpers are now exported from `@npde/docx-editor-core` as the single source of truth, and the React package re-exports them unchanged.
...
- Updated dependencies [28876a2]
  - @npde/docx-editor-core@1.9.0
  - @npde/docx-editor-i18n@1.9.0
  - @npde/docx-editor-agents@1.9.0
...
- Updated dependencies [447d5b0]
  - @npde/docx-editor-core@1.8.3
  - @npde/docx-editor-agents@1.8.3
  - @npde/docx-editor-i18n@1.8.3
...
- Updated dependencies [7811a73]
  - @npde/docx-editor-core@1.8.2
  - @npde/docx-editor-agents@1.8.2
  - @npde/docx-editor-i18n@1.8.2
...
- Updated dependencies [6047f84]
  - @npde/docx-editor-core@1.8.1
  - @npde/docx-editor-agents@1.8.1
  - @npde/docx-editor-i18n@1.8.1
...
- Updated dependencies [114e83e]
  - @npde/docx-editor-agents@1.8.0
  - @npde/docx-editor-core@1.8.0
  - @npde/docx-editor-i18n@1.8.0
...
- Updated dependencies [d4a27d4]
  - @npde/docx-editor-core@1.7.0
  - @npde/docx-editor-agents@1.7.0
  - @npde/docx-editor-i18n@1.7.0
...
- Updated dependencies [768b10e]
  - @npde/docx-editor-core@1.6.2
  - @npde/docx-editor-agents@1.6.2
  - @npde/docx-editor-i18n@1.6.2
...
- Updated dependencies [4a75c5e]
  - @npde/docx-editor-agents@1.6.1
  - @npde/docx-editor-i18n@1.6.1
  - @npde/docx-editor-core@1.6.1
...
- Updated dependencies [7fe09f0]
  - @npde/docx-editor-agents@1.6.0
  - @npde/docx-editor-core@1.6.0
  - @npde/docx-editor-i18n@1.6.0
...
- Updated dependencies [44161e5]
  - @npde/docx-editor-core@1.5.0
  - @npde/docx-editor-agents@1.5.0
  - @npde/docx-editor-i18n@1.5.0
...
- Updated dependencies [1ab8b30]
  - @npde/docx-editor-core@1.4.0
  - @npde/docx-editor-agents@1.4.0
  - @npde/docx-editor-i18n@1.4.0
...
- Updated dependencies [30df527]
  - @npde/docx-editor-core@1.3.3
  - @npde/docx-editor-agents@1.3.3
  - @npde/docx-editor-i18n@1.3.3
...
- Updated dependencies [58e3a7e]
  - @npde/docx-editor-core@1.3.2
  - @npde/docx-editor-agents@1.3.2
  - @npde/docx-editor-i18n@1.3.2
...
- Updated dependencies [66cf3a8]
  - @npde/docx-editor-core@1.3.1
  - @npde/docx-editor-agents@1.3.1
  - @npde/docx-editor-i18n@1.3.1
...
- Updated dependencies [eaa6f7f]
  - @npde/docx-editor-core@1.3.0
  - @npde/docx-editor-agents@1.3.0
  - @npde/docx-editor-i18n@1.3.0
...
- Updated dependencies [1c2b098]
  - @npde/docx-editor-agents@1.2.1
  - @npde/docx-editor-core@1.2.1
  - @npde/docx-editor-i18n@1.2.1
...
- Updated dependencies [e5e0997]
  - @npde/docx-editor-i18n@1.1.0
  - @npde/docx-editor-core@1.1.0
  - @npde/docx-editor-agents@1.1.0
...
- Updated dependencies [e80093d]
  - @npde/docx-editor-core@1.0.3
  - @npde/docx-editor-agents@1.0.3
  - @npde/docx-editor-i18n@1.0.3
...
- Updated dependencies [4e73af5]
  - @npde/docx-editor-core@1.0.2
  - @npde/docx-editor-agents@1.0.2
  - @npde/docx-editor-i18n@1.0.2

## 1.0.1

### Patch Changes

- fe4cb94: Add per-locale subpath imports to `@npde/docx-editor-i18n` so dynamic
  locale loading can code-split a single locale instead of bundling the whole
  set:

  ```ts
  // Static — bundler ships only this locale's strings
  import pl from '@npde/docx-editor-i18n/pl';

  // Dynamic — splits into its own chunk, loaded on demand
  const pl = (await import('@npde/docx-editor-i18n/pl')).default;
  ```
  ...
  `CreateEmptyDocumentOptions` from `@npde/docx-editor-react` and
  `@npde/docx-editor-vue` so the common "spawn a blank editor"
  ...
  `@npde/docx-editor-core` entry. They were already public via
  `@npde/docx-editor-core/headless`; the main entry just hadn't been
  re-exporting them.
...
- Updated dependencies [fe4cb94]
  - @npde/docx-editor-core@1.0.1
  - @npde/docx-editor-i18n@1.0.1
  - @npde/docx-editor-agents@1.0.1
...
- 6272b32: # 1.0.0
  ...
  | ------------------------------------------ | ----------------------------------------- |
  | `@eigenpal/docx-js-editor`                 | `@npde/docx-editor-react`             |
  | `@eigenpal/docx-js-editor/react`           | `@npde/docx-editor-react`             |
  | `@npde/docx-editor-react/core`         | `@npde/docx-editor-core`              |
  | `@npde/docx-editor-react/headless`     | `@npde/docx-editor-core/headless`     |
  | `@npde/docx-editor-react/core-plugins` | `@npde/docx-editor-core/core-plugins` |
  | `@npde/docx-editor-react/mcp`          | `@npde/docx-editor-agents/mcp`        |
  | `@npde/docx-editor-react/i18n/*.json`  | `@npde/docx-editor-i18n/*.json`       |
  ...
  + import { createEmptyDocument } from '@npde/docx-editor-core';
  ```

  ## Vue 3 adapter (`@npde/docx-editor-vue`)
  ...
  ## Shared i18n package (`@npde/docx-editor-i18n`)

  Locale strings move out of `@npde/docx-editor-react` into a dedicated package consumed by both adapters from a single source.

  ```diff
  - import de from '@npde/docx-editor-react/i18n/de.json';
  + import de from '@npde/docx-editor-i18n/de.json';
  ```
  ...
  `AgentPanel`, `AgentChatLog`, `AgentComposer`, `AgentSuggestionChip`, `AgentTimeline` no longer ship from `@npde/docx-editor-react`. They live at:
  - `@npde/docx-editor-agents/react` — React components + `useAgentChat`
  - `@npde/docx-editor-agents/vue` — Vue 3 twins, plus `AIContextMenu` and `AIResponsePreview`
  - `@npde/docx-editor-agents/ai-sdk/react` / `/ai-sdk/vue` — `@ai-sdk/*` adapters
  - `@npde/docx-editor-agents/bridge` — React-free `createEditorBridge`, `agentTools`, `executeToolCall`, `getToolSchemas`, `createReviewerBridge`. Safe for headless / Vue / Node.

  ```diff
  - import { AgentPanel, AgentChatLog } from '@npde/docx-editor-react';
  + import { AgentPanel, AgentChatLog } from '@npde/docx-editor-agents/react';
  ```
  ...
  All published packages relicense to Apache 2.0. Notably: `@npde/docx-editor-agents` was AGPL-3.0-or-later — the relicense lifts copyleft obligations on agent embedders.

- fd1f9de: `@npde/docx-editor-i18n` ships its public surface as named exports from the package root. One import path, IDE-discoverable, tree-shakeable.
...
- 348fa6b: API Extractor snapshots for the 6 published subpaths of `@npde/docx-editor-react` (root, `/ui`, `/hooks`, `/dialogs`, `/plugin-api`, `/styles`) and `@npde/docx-editor-vue` (root, `/ui`, `/composables`, `/dialogs`, `/plugin-api`, `/styles`). CI now fails on undocumented public-surface drift via `bun run api:check`.
  ...
  Side effect for `@npde/docx-editor-vue`: the build no longer writes workspace-relative source paths (e.g. `../../core/src/core.ts`) into published declarations. Those paths were valid in this repo but unresolvable once installed from npm; setting `pathsToAliases: false` on the dts plugin keeps the package names (`@npde/docx-editor-core`, `@npde/docx-editor-i18n`) intact in `dist/*.d.ts`.
...
- Updated dependencies [8836214]
  - @npde/docx-editor-core@1.0.0
  - @npde/docx-editor-agents@1.0.0
  - @npde/docx-editor-i18n@1.0.0
...
- 6094eaf: Built-in agent panel + chat primitives + expanded toolkit so consumers can plug a streaming AI agent into the editor in ~50 lines. See [`docs/agents.md`](../docs/agents.md).
  ...
  ### Toolkit (`@npde/docx-editor-agents`)
  ...
  `@npde/docx-editor-agents`: new `/ai-sdk/server` and `/ai-sdk/react` subpaths (peer dep `ai`, optional). `/server` and `/react` unchanged. `displayName` on `AgentToolDefinition`.
...
- c81fdd3: # Live agent chat + server-side MCP support
  ...
  Exported from `@npde/docx-editor-agents` as `agentTools`, `getToolSchemas()`, `executeToolCall(name, args, bridge)`.
  ...
  import { useAgentChat } from '@npde/docx-editor-agents/bridge';
  const { executeToolCall, toolSchemas } = useAgentChat({ editorRef, author: 'AI' });

  // Server-side, against a parsed DOCX
  import { DocxReviewer, createReviewerBridge } from '@npde/docx-editor-agents';
  ...
  ```ts
  import { McpServer, createReviewerBridge, DocxReviewer } from '@npde/docx-editor-agents';
  import { McpServer as _ } from '@npde/docx-editor-agents/mcp';
