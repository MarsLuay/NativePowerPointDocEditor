 ...
 * @example
 * ```tsx
 * import { Toolbar, FontPicker, ColorPicker } from '@npde/docx-editor-react/ui';
 * ```
 *
...
import { Table, TableCell, ParagraphAlignment, ColorValue, Style, Theme, StyleType, SectionProperties, TabStop, Document } from '@npde/docx-editor-core/types/document';
import { FontOption } from '@npde/docx-editor-core/utils/fontOptions';
export { FontOption } from '@npde/docx-editor-core/utils/fontOptions';
import { ListState } from '@npde/docx-editor-core/utils/listState';
export { ListState, createDefaultListState } from '@npde/docx-editor-core/utils/listState';
import { T as TableSelection, a as TableContext, b as TableSplitConfig, c as TableAction } from './useFindReplace-BEVd1x38.mjs';
export { F as FindReplaceOptions, d as FindReplaceState, e as TableToolbar, f as TableToolbarProps, U as UseFindReplaceReturn, u as useFindReplace } from './useFindReplace-BEVd1x38.mjs';
import { SelectionContext, AIAction, AgentResponse } from '@npde/docx-editor-core/types/agentApi';
import { TranslationKey } from '@npde/docx-editor-i18n';
export { K as DialogKeyboardShortcut, F as FindReplaceDialog, a as FindReplaceDialogProps, H as HyperlinkData, b as HyperlinkDialog, c as HyperlinkDialogProps, d as KeyboardShortcutsDialog, e as KeyboardShortcutsDialogProps, P as PasteOption, f as PasteSpecialDialog, g as PasteSpecialDialogProps, S as ShortcutCategory, U as UseKeyboardShortcutsDialogOptions, h as UseKeyboardShortcutsDialogReturn, i as UsePasteSpecialOptions, j as UsePasteSpecialReturn, k as formatShortcutKeys, l as getAllCategories, m as getAllPasteOptions, n as getCategoryLabel, o as getCommonShortcuts, p as getDefaultPasteOption, q as getDefaultShortcuts, r as getPasteOption, s as getShortcutsByCategory, t as isPasteSpecialShortcut, u as useHyperlinkDialog, v as useKeyboardShortcutsDialog, w as usePasteSpecial } from './KeyboardShortcutsDialog-DDN-wlZe.mjs';
...
export { PrintOptions, formatPageRange as formatPrintPageRange, getDefaultPrintOptions, isPrintSupported, openPrintWindow, parsePageRange, triggerPrint } from '@npde/docx-editor-core';
import '@npde/docx-editor-core/utils';
 ...
 */
type FormattingAction = 'bold' | 'italic' | 'underline' | 'strikethrough' | 'superscript' | 'subscript' | 'clearFormatting' | 'addParagraphBottomBorder' | 'clearParagraphBorders' | 'bulletList' | 'numberedList' | 'indent' | 'outdent' | 'insertLink' | 'setRtl' | 'setLtr' | {
    type: 'fontFamily';
    value: string;
} | {
    type: 'fontSize';
...
interface ToolbarButtonProps {
    ...
    /** Whether the button is disabled */
    disabled?: boolean;
    /** Optional label seed for test ids; not shown as a hover tooltip. */
    title?: string;
    /** Click handler */
    onClick?: () => void;
    /** Button content */
