...
import { SidebarItem, EditorPluginCore, PluginPanelProps, RenderedDomContext, SidebarItemContext } from '@npde/docx-editor-core/plugin-api';
...
interface ReactEditorPlugin<TState = unknown> extends EditorPluginCore<TState> {
    /**
 ...
 */
type EditorPlugin<TState = unknown> = ReactEditorPlugin<TState>;
/**
