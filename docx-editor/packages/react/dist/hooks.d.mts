 ...
 * @example
 * ```tsx
 * import { useAutoSave, useFindReplace } from '@npde/docx-editor-react/hooks';
 * ```
 *
 * @packageDocumentation
 * @public
 */
import { Table, Document } from '@npde/docx-editor-core/types/document';
import { a as TableContext, c as TableAction, b as TableSplitConfig } from './useFindReplace-BEVd1x38.mjs';
export { F as FindReplaceOptions, d as FindReplaceState, U as UseFindReplaceReturn, u as useFindReplace } from './useFindReplace-BEVd1x38.mjs';
import * as React$1 from 'react';
import React__default, { CSSProperties, RefObject } from 'react';
import { HighlightRect, SelectionHighlightConfig, ParsedClipboardContent } from '@npde/docx-editor-core/utils';
import { ClipboardSelection, Theme, SavedDocumentData, AutoSaveStatus } from '@npde/docx-editor-core';
export { AutoSaveStatus, ClipboardSelection, SavedDocumentData, TABLE_DATA_ATTRIBUTES, createSelectionFromDOM, formatLastSaveTime, formatStorageSize, getAutoSaveStatusLabel, getAutoSaveStorageSize, getSelectionRuns, isAutoSaveSupported } from '@npde/docx-editor-core';
import { EditorView } from 'prosemirror-view';
import { EditorState } from 'prosemirror-state';
import { TrackedChangesResult } from '@npde/docx-editor-core/prosemirror/utils/extractTrackedChanges';
export { TrackedChangesResult, extractTrackedChanges } from '@npde/docx-editor-core/prosemirror/utils/extractTrackedChanges';
import '@npde/docx-editor-core/utils/findReplace';
