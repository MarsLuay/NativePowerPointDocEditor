...
import { Document, HeaderFooter, Theme } from '@npde/docx-editor-core/types/document';
import { FontOption } from '@npde/docx-editor-core/utils/fontOptions';
import { R as ReactSidebarItem } from './types-D4kZpqv7.mjs';
import { Comment } from '@npde/docx-editor-core/types/content';
import { Translations, TFunction } from '@npde/docx-editor-i18n';
import { PrintOptions, EditorHandle } from '@npde/docx-editor-core';
export { CreateEmptyDocumentOptions, createDocumentWithText, createEmptyDocument } from '@npde/docx-editor-core';
import { ScrollToParaIdOptions, DocxInput, FontDefinition } from '@npde/docx-editor-core/utils';
import { SelectionState, PMContentControl } from '@npde/docx-editor-core/prosemirror';
import { ContentControlFilter, ContentControlValue } from '@npde/docx-editor-core/contentControls';
import { Layout } from '@npde/docx-editor-core/layout-engine';
import { RenderedDomContext } from '@npde/docx-editor-core/plugin-api';
 ...
 *
 * Returns an `EditorHandle` (from @npde/docx-editor-core) that works with
