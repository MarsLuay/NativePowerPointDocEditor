...
```tsx
import { DocxEditor, PluginHost, templatePlugin } from '@npde/docx-editor-react';
...
```tsx
import { DocxEditor, PluginHost } from '@npde/docx-editor-react';
import { createPlugin } from '@npde/docx-editor-react';
...
```tsx
import { processTemplate } from '@npde/docx-editor-react';
