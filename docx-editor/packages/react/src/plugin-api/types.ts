...
export type {
  ...
  SidebarItem,
  SidebarItemContext,
} from '@npde/docx-editor-core/plugin-api';
...
export interface ReactEditorPlugin<TState = unknown> extends EditorPluginCore<TState> {
  /**
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export type EditorPlugin<TState = unknown> = ReactEditorPlugin<TState>;
