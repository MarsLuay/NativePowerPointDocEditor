...
import type { Watermark } from '@npde/docx-editor-core/types/document';
import {
        ...
        <div style={BODY}>
          <div style={RADIO_ROW}>
            <input
              ...
              id="wm-none"
              checked={mode === 'none'}
              aria-label={t('dialogs.watermark.noWatermark')}
          ...
          <div style={RADIO_ROW}>
            <input
              ...
              aria-label={t('dialogs.watermark.picture')}
            ...
            <div style={SUBFORM}>
              <div style={ROW}>
                <input
                  type="file"
                  accept="image/*"
                  aria-label={t('dialogs.watermark.selectPicture')}
              ...
              <div style={ROW}>
                ...
                <input
                  ...
                  max={500}
                  value={scale}
                  aria-label={t('dialogs.watermark.scale')}
            ...
            <div style={SUBFORM}>
              ...
              <div style={ROW}>
                ...
                <input
                  style={INPUT}
                  value={text}
                  aria-label={t('dialogs.watermark.textLabel')}
              ...
              <div style={ROW}>
                ...
                {!autoSize && (
                  <input
                    ...
                    max={200}
                    value={fontSize}
                    aria-label={t('dialogs.watermark.sizeLabel')}
              ...
              <div style={ROW}>
                ...
                <input
                  type="color"
                  value={color}
                  aria-label={t('dialogs.watermark.colorLabel')}
