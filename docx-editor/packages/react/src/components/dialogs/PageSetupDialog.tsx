...
import type { SectionProperties } from '@npde/docx-editor-core/types/document';
import { TWIPS_PER_INCH } from '@npde/docx-editor-core/utils';
        ...
        <div style={bodyStyle}>
          ...
          <div style={rowStyle}>
            ...
            <input
              ...
              max={10}
              step={0.1}
              aria-label={t('dialogs.pageSetup.top')}
          ...
          <div style={rowStyle}>
            ...
            <input
              ...
              max={10}
              step={0.1}
              aria-label={t('dialogs.pageSetup.bottom')}
          ...
          <div style={rowStyle}>
            ...
            <input
              ...
              max={10}
              step={0.1}
              aria-label={t('dialogs.pageSetup.left')}
          ...
          <div style={rowStyle}>
            ...
            <input
              ...
              max={10}
              step={0.1}
              aria-label={t('dialogs.pageSetup.right')}
