            ...
            {hMode === 'align' ? (
              ...
              <div style={rowStyle}>
                ...
                <input
                  type="number"
                  style={inputStyle}
                  aria-label={t('dialogs.imagePosition.offsetPx')}
                  value={hOffset}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
              <div style={rowStyle}>
                ...
                <input
                  ...
                  style={inputStyle}
                  min={0}
                  aria-label={t('dialogs.imagePosition.alignOptions.top')}
                  value={distTop}
              ...
              <div style={rowStyle}>
                ...
                <input
                  ...
                  style={inputStyle}
                  min={0}
                  aria-label={t('dialogs.imagePosition.alignOptions.bottom')}
                  value={distBottom}
              ...
              <div style={rowStyle}>
                ...
                <input
                  ...
                  style={inputStyle}
                  min={0}
                  aria-label={t('dialogs.imagePosition.alignOptions.left')}
                  value={distLeft}
              ...
              <div style={rowStyle}>
                ...
                <input
                  ...
                  style={inputStyle}
                  min={0}
                  aria-label={t('dialogs.imagePosition.alignOptions.right')}
                  value={distRight}
