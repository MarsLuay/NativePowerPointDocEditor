          ...
          <div style={sectionStyle}>
            ...
            <div style={rowStyle}>
              ...
              <input
                ...
                min={1}
                step={1}
                aria-label={t('dialogs.imageProperties.widthLabel')}
                value={width}
            ...
            <div style={rowStyle}>
              ...
              <input
                ...
                min={1}
                step={1}
                aria-label={t('dialogs.imageProperties.heightLabel')}
                value={height}
          ...
          <div style={sectionStyle}>
            ...
            <div style={rowStyle}>
              ...
              <input
                ...
                max={20}
                step={0.5}
                aria-label={t('dialogs.imageProperties.width')}
                value={borderWidth}
            ...
            <div style={rowStyle}>
              ...
              <input
                type="color"
                value={borderColor}
                aria-label={t('dialogs.imageProperties.color')}
