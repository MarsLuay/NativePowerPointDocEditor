...
import { schema } from '@npde/docx-editor-core/prosemirror';
import { proseDocToBlocks } from '@npde/docx-editor-core/prosemirror/conversion';
import { Z_INDEX } from '../styles/zIndex';
import type { HeaderFooter, BlockContent } from '@npde/docx-editor-core/types/document';
  ...
  return (
    <div style={{ position: 'relative' }} ref={optionsRef}>
      <button
        ...
        aria-label={t('headerFooter.options')}
        onClick={(e) => {
          e.stopPropagation();
      ...
      {showOptions && (
        <div style={dropdownStyle} onMouseDown={(e) => e.stopPropagation()}>
          ...
          */}
          <button
            type="button"
            aria-label={t('headerFooter.insertPageNumber')}
          ...
          <button
            type="button"
            aria-label={t('headerFooter.insertTotalPages')}
            style={dropdownItemStyle}
            onClick={() => {
              setShowOptions(false);
          ...
          {onRemove && (
            <button
              type="button"
              aria-label={t('headerFooter.remove', { label: label.toLowerCase() })}
              style={dropdownItemStyle}
              onClick={() => {
                setShowOptions(false);
                onRemove();
          ...
          <button
            type="button"
            aria-label={t('headerFooter.closeEditing', { label: label.toLowerCase() })}
            style={dropdownItemStyle}
            onClick={() => {
              setShowOptions(false);
              onClose();
