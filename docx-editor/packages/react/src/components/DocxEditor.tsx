...
import type { Document, Theme } from '@npde/docx-editor-core/types/document';
...
import { type DocxInput } from '@npde/docx-editor-core/utils';
import type { FontDefinition, ScrollToParaIdOptions } from '@npde/docx-editor-core/utils';
import { useFontLifecycle } from '../hooks/useFontLifecycle';
import { useTableSelection } from '../hooks/useTableSelection';
import { useDocumentHistory } from '../hooks/useHistory';

// Extension system
import { createStarterKit } from '@npde/docx-editor-core/prosemirror/extensions';
import { ExtensionManager } from '@npde/docx-editor-core/prosemirror/extensions';
import {
  createSuggestionModePlugin,
  setSuggestionMode,
} from '@npde/docx-editor-core/prosemirror/plugins';
...
} from '@npde/docx-editor-core/prosemirror';
import type {
  ContentControlFilter,
  ContentControlValue,
} from '@npde/docx-editor-core/contentControls';
import {
  acceptChange,
  rejectChange,
  acceptChangeById,
...
import { collectHeadings } from '@npde/docx-editor-core/utils';
import {
...
interface EditorState {
  ...
  paragraphTabs: import('@npde/docx-editor-core/types/document').TabStop[] | null;
...
// `@npde/docx-editor-core/docx` so React + Vue share the same
...
export const DocxEditor = forwardRef<DocxEditorRef, DocxEditorProps>(function DocxEditor(
  ...
  if (state.isLoading) {
    return (
      <div
        className={cn('docx-editor-root docx-editor docx-editor-loading', isDark && 'dark', className)}
  ...
  if (state.parseError) {
    return (
      <div
        className={cn('docx-editor-root docx-editor docx-editor-error', isDark && 'dark', className)}
        style={containerStyle}
        data-testid="docx-editor"
      >
  ...
  if (!history.state) {
    return (
      <div
        className={cn('docx-editor-root docx-editor docx-editor-empty', isDark && 'dark', className)}
        style={containerStyle}
        data-testid="docx-editor"
      >
