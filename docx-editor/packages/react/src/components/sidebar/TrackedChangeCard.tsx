      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
        ...
        {isExpanded && (
          <div style={{ display: 'flex', gap: 4, marginTop: 2 }}>
            <button onClick={handleAccept} aria-label={t('common.accept')} title={t('common.accept')} style={ICON_BUTTON_STYLE}>
              <MaterialSymbol name="check" size={20} />
            </button>
            <button onClick={handleReject} aria-label={t('common.reject')} title={t('common.reject')} style={ICON_BUTTON_STYLE}>
