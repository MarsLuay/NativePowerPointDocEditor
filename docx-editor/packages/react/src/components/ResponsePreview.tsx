...
import type { AIAction, AgentResponse } from '@npde/docx-editor-core/types/agentApi';
import { getActionLabel } from '@npde/docx-editor-core/types/agentApi';
      ...
      >
        {isEditing ? (
          <div>
            ...
            <textarea
              ref={textareaRef}
              aria-label={t('responsePreview.editPrompt')}
              value={editedText}
      ...
      >
        <div>
          ...
          {isEditing && (
            <button
              type="button"
              aria-label={t('responsePreview.cancelEdit')}
