...
import type { TableContextInfo } from '@npde/docx-editor-core/prosemirror/extensions';
import { useTranslation } from '../../i18n';
import type { TranslationKey } from '@npde/docx-editor-i18n';
...
const MARGIN_SIDE_LABEL_KEYS = {
  top: 'dialogs.pageSetup.top',
  bottom: 'dialogs.pageSetup.bottom',
  left: 'dialogs.pageSetup.left',
  right: 'dialogs.pageSetup.right',
} as const satisfies Record<'top' | 'bottom' | 'left' | 'right', TranslationKey>;
...
function CellMarginsRow({ onAction }: { onAction: (action: TableAction) => void }) {
  ...
  return (
    <div>
      <button
        type="button"
        aria-label={t('tableAdvanced.cellMargins')}
        style={{
          ...menuItemStyles,
            ...
            {(['top', 'bottom', 'left', 'right'] as const).map((side) => (
              ...
              >
                ...
                <input
                  ...
                  min={0}
                  step={20}
                  aria-label={`${t('tableAdvanced.cellMargins')} ${t(MARGIN_SIDE_LABEL_KEYS[side])}`}
...
function TextDirectionRow({ onAction }: { onAction: (action: TableAction) => void }) {
  ...
  return (
    <div>
      <button
        type="button"
        aria-label={t('tableAdvanced.textDirection')}
        style={{
          ...menuItemStyles,
          backgroundColor: hoveredItem === 'main' ? 'var(--doc-bg-hover)' : 'transparent',
        }}
...
function NoWrapRow({ onAction }: { onAction: (action: TableAction) => void }) {
  ...
  return (
    <button
      type="button"
      aria-label={t('tableAdvanced.toggleNoWrap')}
      style={{
        ...menuItemStyles,
        backgroundColor: hoveredItem === 'main' ? 'var(--doc-bg-hover)' : 'transparent',
      }}
...
function RowHeightRow({ onAction }: { onAction: (action: TableAction) => void }) {
  ...
  return (
    <div>
      <button
        type="button"
        aria-label={t('tableAdvanced.rowHeight')}
        style={{
          ...menuItemStyles,
          backgroundColor: hoveredItem === 'main' ? 'var(--doc-bg-hover)' : 'transparent',
        }}
          ...
          {heightRule !== 'auto' && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
              ...
              <input
                ...
                step={20}
                value={heightValue}
                aria-label={t('tableAdvanced.height')}
...
function HeaderRowRow({ onAction }: { onAction: (action: TableAction) => void }) {
  ...
  return (
    <button
      type="button"
      aria-label={t('tableAdvanced.toggleHeaderRow')}
      style={{
        ...menuItemStyles,
        backgroundColor: hoveredItem === 'main' ? 'var(--doc-bg-hover)' : 'transparent',
      }}
...
function DistributeColumnsRow({ onAction }: { onAction: (action: TableAction) => void }) {
  ...
  return (
    <button
      type="button"
      aria-label={t('tableAdvanced.distributeColumns')}
      style={{
        ...menuItemStyles,
        backgroundColor: hoveredItem === 'main' ? 'var(--doc-bg-hover)' : 'transparent',
      }}
...
function AutoFitRow({ onAction }: { onAction: (action: TableAction) => void }) {
  ...
  return (
    <button
      type="button"
      aria-label={t('tableAdvanced.autoFit')}
      style={{
        ...menuItemStyles,
        backgroundColor: hoveredItem === 'main' ? 'var(--doc-bg-hover)' : 'transparent',
      }}
...
function TablePropertiesRow({ onAction }: { onAction: (action: TableAction) => void }) {
  ...
  return (
    <>
      ...
      <button
        type="button"
        aria-label={t('tableAdvanced.tableProperties')}
        style={{
          ...menuItemStyles,
          backgroundColor: hoveredItem === 'main' ? 'var(--doc-bg-hover)' : 'transparent',
        }}
