...
import type { NumberFormat } from '@npde/docx-editor-core/types/document';
...
export type { ListType, ListState } from '@npde/docx-editor-core/utils/listState';
import type { ListState } from '@npde/docx-editor-core/utils/listState';
...
export {
  ...
  toggleListType,
} from '@npde/docx-editor-core/utils/listState';
