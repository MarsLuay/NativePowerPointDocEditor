...
import { resolveColorToHex } from '@npde/docx-editor-core/utils';
...
export function ToolbarButton({
  ...
  // Host (Obsidian plugin) owns tooltips / suppresses hover chrome on this rail.
  // Do not wrap in vendor <Tooltip> — that floated "Insert link (Ctrl+K)" etc.
  return (
    <Button
      variant="ghost"
      size="icon-sm"
