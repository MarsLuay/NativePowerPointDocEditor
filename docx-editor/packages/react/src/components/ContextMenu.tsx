...
import type { AIAction, SelectionContext } from '@npde/docx-editor-core/types/agentApi';
import {
  getActionDescription,
  DEFAULT_AI_ACTIONS,
} from '@npde/docx-editor-core/types/agentApi';
    ...
    >
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          aria-label={t('contextMenu.customPromptPlaceholder')}
