...
import type { SectionProperties, TabStop } from '@npde/docx-editor-core/types/document';
import type { TrackedChangesResult } from '@npde/docx-editor-core/prosemirror/utils/extractTrackedChanges';
import { LocaleProvider } from '../../i18n';
import { cn } from '../../lib/utils';
import { EditorIsDarkProvider } from '../EditorColorModeContext';
...
import type { HeadingInfo } from '@npde/docx-editor-core/utils';
 ...
 * + toggle button, plus slots for the toolbar,
...
export function DocxEditorShell({
  ...
  return (
    <LocaleProvider i18n={i18n}>
      <EditorIsDarkProvider isDark={Boolean(isDark)}>
        <ErrorProvider>
          <ErrorBoundary onError={onEditorError}>
            <div
              ref={containerRef}
              className={cn('docx-editor-root docx-editor', isDark && 'dark', className)}
