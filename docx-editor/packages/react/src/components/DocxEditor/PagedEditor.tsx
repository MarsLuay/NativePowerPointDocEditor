...
// Layout engine
import type { Layout } from '@npde/docx-editor-core/layout-engine';
import type { ScrollToParaIdOptions } from '@npde/docx-editor-core/utils';

// Layout bridge
import { DEFAULT_PAGE_HEIGHT_PX } from '@npde/docx-editor-core/layout-bridge';
...
import type {
  ...
  SectionProperties,
  HeaderFooter,
} from '@npde/docx-editor-core/types/document';
...
export interface PagedEditorProps {
  ...
  extensionManager?: import('@npde/docx-editor-core/prosemirror/extensions').ExtensionManager;
...
const PagedEditorComponent = forwardRef<PagedEditorRef, PagedEditorProps>(
  function PagedEditor(props, ref) {
    ...
    return (
      <div
        ref={containerRef}
        className={`docx-editor-root paged-editor ${className ?? ''}`}
