...
import type { SelectionRect, CaretPosition } from '@npde/docx-editor-core/layout-bridge';
...
// Obsidian keeps Word-white pages (no canvas invert). Do not use --doc-caret:
// vendor `.dark` paints that light for inverted canvas and wins in practice.
const DEFAULT_CARET_COLOR = '#000000';
...
export function useSelectionOverlay(
  ...
  layout: import('@npde/docx-editor-core/layout-engine').Layout | null,
  blocks: import('@npde/docx-editor-core/layout-engine').FlowBlock[],
  measures: import('@npde/docx-editor-core/layout-engine').Measure[]
): {
  selectionRects: SelectionRect[];
  caretPosition: CaretPosition | null;
} {
  ...
  useEffect(() => {
    ...
    import('@npde/docx-editor-core/layout-bridge')
      .then(({ selectionToRects, getCaretPosition }) => {
