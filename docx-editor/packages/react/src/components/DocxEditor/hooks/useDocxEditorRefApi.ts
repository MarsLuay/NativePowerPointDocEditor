...
} from '@npde/docx-editor-core/prosemirror/queries';
import {
  applyFormatting,
  setParagraphStyle,
  insertBreak,
} from '@npde/docx-editor-core/prosemirror/applyFormatting';
import {
  ContentControlNotFoundError,
  type ContentControlFilter,
  type ContentControlValue,
} from '@npde/docx-editor-core/contentControls';
import type { DocxInput, ScrollToParaIdOptions } from '@npde/docx-editor-core/utils';
import { getCachedNumberingMap } from '@npde/docx-editor-core/docx';
import type { DocxEditorRef } from '../../DocxEditor';
import type { PagedEditorRef } from '../PagedEditor';
import {
  addCommentToRange,
  applyProposedChange,
} from '@npde/docx-editor-core/prosemirror/commentOps';
import type { CommentIdAllocator } from '@npde/docx-editor-core/prosemirror/commentIdAllocator';
