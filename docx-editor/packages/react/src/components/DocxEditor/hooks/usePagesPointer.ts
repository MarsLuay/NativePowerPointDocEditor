...
import type { CaretPosition, SelectionRect } from '@npde/docx-editor-core/layout-bridge';
import {
  clickToPosition,
  clickToPositionDom,
...
} from '@npde/docx-editor-core/layout-bridge';
import type { FlowBlock, Layout, Measure } from '@npde/docx-editor-core/layout-engine';
import { addColumnRight, addRowBelow } from '@npde/docx-editor-core/prosemirror';
import {
  captureInlinePositionEmu,
  findImageElement as coreFindImageElement,
  hitTestImage,
} from '@npde/docx-editor-core/layout-painter';
import type { WrapType } from '@npde/docx-editor-core/docx/wrapTypes';
import { findWordBoundaries } from '@npde/docx-editor-core/utils';
...
} from '@npde/docx-editor-core/prosemirror/cellDragSelection';
      ...
      if (anchorEl && surface) {
        ...
        if (href.startsWith('#')) {
          ...
          if (!hasRangeSelection) {
            ...
            const root = anchorEl.closest('.docx-editor-root.paged-editor') as HTMLElement | null;
            if (root) {
