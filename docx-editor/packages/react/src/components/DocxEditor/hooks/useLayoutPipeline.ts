...
import { getMargins, getPageSize, getColumns } from '@npde/docx-editor-core/layout-bridge';
...
} from '@npde/docx-editor-core/editor';
import { findVerticalScrollParentOrRoot } from '@npde/docx-editor-core/utils/findVerticalScrollParent';
import type {
  Document,
  HeaderFooter,
  SectionProperties,
  ...
  const runLayoutPipeline = useCallback(
    (state: EditorState) => {
      ...
      try {
        ...
        // `@npde/docx-editor-core/editor`. Paint + scroll/events stay here.
        const {
          blocks: newBlocks,
