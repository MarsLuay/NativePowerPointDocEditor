...
import { findBodyPmAnchors } from '@npde/docx-editor-core/layout-bridge';
import type { Document, SectionProperties } from '@npde/docx-editor-core/types/document';

// `findParaIdRange` moved to `@npde/docx-editor-core/prosemirror/paraText`;
