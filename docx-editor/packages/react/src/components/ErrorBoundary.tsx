...
import { ErrorManager } from '@npde/docx-editor-core';
import type { ErrorSeverity, ErrorNotification } from '@npde/docx-editor-core';
  ...
  return (
    ...
    >
      ...
      <div style={headerStyle}>
          ...
          {notification.details && (
            <>
              <button
                ...
                aria-label={isExpanded ? t('errors.hideDetails') : t('errors.showDetails')}
                style={{
                  ...buttonStyle,
                  marginTop: '4px',
                  fontSize: '12px',
        ...
        <button type="button" onClick={onDismiss} style={buttonStyle} aria-label={t('common.dismiss')}>
