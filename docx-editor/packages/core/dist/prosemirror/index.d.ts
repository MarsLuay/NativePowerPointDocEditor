...
export { addTabStop, alignCenter, alignJustify, alignLeft, alignRight, applyStyle, clearParagraphBorders, clearStyle, decreaseIndent, decreaseListLevel, generateTOC, getListInfo, getParagraphAlignment, getParagraphBidi, getStyleId, increaseIndent, increaseListLevel, isInList, removeList, removeTabStop, setAlignment, setIndentFirstLine, setIndentLeft, setIndentRight, setLineSpacing, setLtr, setParagraphBottomBorder, setRtl, toggleBulletList, toggleNumberedList } from './commands/paragraph.js';
...
import { a as ContentControlFilter, h as ContentControlValue } from '../contentControlValues-gVx9t8tg.js';
 ...
 */
declare function applyPostSplitInheritance(tr: Transaction, sourcePara: Node | null, styleMarks: readonly Mark[], schema: Schema, resolver?: StyleResolver | null): void;
/** Enter command chain used by BaseKeymap and host focus bridges. */
declare const enterCommand: Command;

export { type PMContentControl, type SelectionState, StyleResolver, addRepeatingSectionItemTr, applyPostSplitInheritance, ensureParaIdsInState, enterCommand, extractSelectionState, findContentControlPos, findContentControlsInPM, removeContentControlTr, removeRepeatingSectionItemTr, setContentControlContentTr, setContentControlValueAtPosTr, setContentControlValueTr };
