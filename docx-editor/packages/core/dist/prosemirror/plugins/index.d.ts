...
import { a as RevisionInfo } from '../../content-B8ScSBzC.js';
import '../../formatting-JhqWT_XM.js';
import '../../colors-C3vA7HUU.js';
import '../../styles-2J4U-Lgk.js';
import '../../styleResolver-CJ1AB9Qd.js';
 ...
 * @example
 * ```ts
 * import { toggleSuggestionMode } from '@npde/docx-editor-core/prosemirror/plugins';
 ...
 * @example
 * ```ts
 * import { setSuggestionMode } from '@npde/docx-editor-core/prosemirror/plugins';
 ...
 * to do anything** — both adapters (`@npde/docx-editor-react`,
 * `@npde/docx-editor-vue`) auto-mount this inside the `DocxEditor`
 ...
 * @example
 * ```ts
 * import { createSuggestionModePlugin } from '@npde/docx-editor-core/prosemirror/plugins';
 *
