...
export { insertSectionBreakContinuous, insertSectionBreakNextPage } from './sectionBreak.js';
 ...
 * @example
 * ```ts
 * import { acceptChange } from '@npde/docx-editor-core/prosemirror/commands';
 ...
 * @example
 * ```ts
 * import { acceptAllChanges } from '@npde/docx-editor-core/prosemirror/commands';
 ...
 * @example
 * ```ts
 * import { acceptChangeById } from '@npde/docx-editor-core/prosemirror/commands';
