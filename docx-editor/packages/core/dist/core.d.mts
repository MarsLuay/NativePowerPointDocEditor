/**
 * @npde/docx-editor-core (default entry point)
 *
 * Fat barrel that re-exports the parser, serializer, plugin
 ...
 * specific slice should prefer the smaller subpaths (`./docx`,
 * `./prosemirror`, `./layout-*`, `./utils`) — they tree-shake better.
 *
 * @example
 * ```ts
 * import { parseDocx, serializeDocx, resolveColor } from '@npde/docx-editor-core';
 * ```
...
export { C as CreateEmptyDocumentOptions, P as ProcessTemplateOptions, a as ProcessTemplateResult, z as ThemeMatrixCell, b as blendColors, c as colorsEqual, d as createDocumentWithText, e as createEmptyDocument, f as createRgbColor, h as createThemeColor, i as darkenColor, A as ensureHexPrefix, B as generateThemeTintShadeMatrix, j as getContrastingColor, l as getTemplateTags, D as getThemeTintShadeHex, m as isBlack, n as isWhite, o as lightenColor, p as parseColorString, r as processTemplate, t as processTemplateAsBlob, u as processTemplateDetailed, v as resolveColor, w as resolveHighlightColor, E as resolveHighlightToCss, x as resolveShadingColor, y as validateTemplate } from './colorResolver-BPAXNZxQ.mjs';
export { j as findContentControl, k as findContentControls, m as getContentControlText, r as removeContentControl, s as setContentControlContent, n as setContentControlValue } from './contentControlValues-DrKO5912.mjs';
export { addRepeatingSectionItem, createContentControl, getBlockIndexForParagraph, getBodyText, getParagraphText, removeRepeatingSectionItem } from './contentControls/index.mjs';
...
export { C as CorePlugin, e as McpSession, M as McpToolDefinition, i as McpToolHandler, j as McpToolResult } from './types-B-iZWEFz.mjs';
export { P as PluginRegistry, p as pluginRegistry, r as registerPlugins } from './registry-B78PDzyN.mjs';
