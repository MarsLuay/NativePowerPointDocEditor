...
import { Position, Range, AgentCommand } from './types/agentApi.mjs';

/**
 * Core Plugin System Types
 *
 * Defines the interfaces for headless plugins that work in Node.js
 * without React/DOM dependencies. These plugins extend headless document tooling
 ...
 *
 * Plugins can:
 * - Register command handlers for template / tooling integrations
...
interface CorePlugin {
     ...
     * Host code may dispatch commands to these handlers.
     *
     * @example
     * ```ts
     * commandHandlers: {
