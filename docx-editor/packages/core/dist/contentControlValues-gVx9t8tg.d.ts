...
import { s as SdtType, t as SdtProperties, u as SdtDataBinding, D as DocumentBody, v as BlockSdt, w as InlineSdt, B as BlockContent } from './content-B8ScSBzC.js';
 ...
 * programmatic edits: they survive the round trip (see the parser + serializer)
 * and carry a stable `tag`/`alias`/`id`. This module discovers and edits them
 * without a DOM or an editor instance, so headless pipelines can find an anchor
 * by tag and act on it.
 *
