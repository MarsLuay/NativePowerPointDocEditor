...
import { FlowBlock, Measure, BlockId, LayoutOptions, FootnoteContent, Layout, Page, PageMargins, ImageRun } from './layout-engine/types.js';
import { F as Footnote, y as HeaderFooter } from './content-B8ScSBzC.js';
import { S as StyleDefinitions, T as Theme } from './styles-2J4U-Lgk.js';
...
type DomDocument = Window['document'];
 ...
 * @public
 */
declare function computeHfCaretRectFromView(view: EditorView, section: 'header' | 'footer', doc?: DomDocument): {
    top: number;
    left: number;
    height: number;
} | null;
 ...
 * @public
 */
declare function computeHfSelectionRectsFromView(view: EditorView, section: 'header' | 'footer', doc?: DomDocument): Array<{
    top: number;
    left: number;
    width: number;
    height: number;
