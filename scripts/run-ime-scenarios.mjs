...
</style></head><body><div class="workspace-shell"><div class="native-powerpoint-doc-editor-host"><div class="editor-transform"><div class="layout-page-content"><span class="docx-run-editable" contenteditable="true">Japanese IME caret probe line.</span></div></div></div></div>
