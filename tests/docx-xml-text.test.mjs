...
import { decodeDocxXmlEntities, normalizeDocxExtractedText } from '../src/docxXmlText.ts';
...
test('normalizeDocxExtractedText normalizes line endings and spaces correctly', () => {
